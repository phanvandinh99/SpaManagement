class Search {
    ...
    constructor(t = {}) {
        return (
            ...
            document.getElementById(this.settings.searchInputId)
                ? (this._addListeners(), this._init(), this._autoComplete)
                : null
        );
    }
    _init() {
        ...
        this._autoComplete = new autoComplete({
            ...
            sort: (t, e) =>
                t.match < e.match ? -1 : t.match > e.match ? 1 : 0,
            ...
            resultItem: {
                content: (t, e) => {
                    (e.innerHTML =
                        '<p class="mb-0">' +
                        t.match +
                        '</p><p class="text-small text-muted mb-0">' +
                        Helpers.UrlFix(t.value.url) +
                        "</p>"),
